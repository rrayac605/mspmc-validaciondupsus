package mx.gob.imss.cit.pmc.validaciondupsus.security;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
	...
	private void setUpSpringAuthentication(TokenInfoModel tokenInfoModel) {
	    ...
	    String user = tokenInfoModel.getUserId();
	    String password = tokenInfoModel.getTokenId();
	...
	private boolean existeJWTToken(HttpServletRequest request) {
		...
		return authenticationHeader.isEmpty() || !authenticationHeader.startsWith(PREFIX) ? false : true;
